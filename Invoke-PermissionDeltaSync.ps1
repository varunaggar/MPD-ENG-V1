            ...
            try {
                switch ($e.ActionType) {
                    'Add-MailboxFolderPermission' {
                        ...
                        # Fix B: Soft-delete any existing active row first — makes Add
                        # idempotent on overlap reprocessing and prevents unique-index
                        # violation if the baseline already captured this permission.
